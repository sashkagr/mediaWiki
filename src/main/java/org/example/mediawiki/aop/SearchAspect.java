...
public class SearchAspect {
    ...
    public Object aroundCreateAdvice(final ProceedingJoinPoint joinPoint) {
        ...
        if (methodSignature.getName().equals("createSearchAndPages")) {
            return argumentLogger.processMethod(joinPoint, "createSearchAndPages",
    ...
    public Object checkStartMethod(final ProceedingJoinPoint joinPoint) {
        ...
        switch (method) {
            case "getSearchById" -> {
                return argumentLogger.processMethod(joinPoint, "getSearchById",
            ...
            case "getSearchByTitle" -> {
                return argumentLogger.processMethod(joinPoint, "getSearchByTitle",
            ...
            case "getSearchExistingById" -> {
                return argumentLogger.processMethod(joinPoint, "getSearchExistingById",
